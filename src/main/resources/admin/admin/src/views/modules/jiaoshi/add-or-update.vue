	...
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0.5% 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="教师电话" prop="jiaoshidianhua">
					<el-input v-model="ruleForm.jiaoshidianhua" placeholder="教师电话" clearable  :readonly="ro.jiaoshidianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0.5% 20px","display":"inline-block"}' v-else class="input" label="教师电话" prop="jiaoshidianhua">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0.5% 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="班级" prop="banji">
